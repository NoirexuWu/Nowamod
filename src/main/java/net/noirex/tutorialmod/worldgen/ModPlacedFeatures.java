...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> MOON_FRAGMENT_PLACED_KEY = createKey("moon_fragment_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, MOON_FRAGMENT_PLACED_KEY,configuredFeatures.getOrThrow(ModConfiguredFeatures.OVERWORLD_DIRTY_MOON_FRAGMENT_ORE_KEY),
                ModOrePlacement.commonOrePlacement(7, //veins per chunck
                        HeightRangePlacement.triangle(VerticalAnchor.absolute(-32),VerticalAnchor.absolute(62))));
    }
