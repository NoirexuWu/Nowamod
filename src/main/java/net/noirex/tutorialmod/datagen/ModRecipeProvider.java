...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        oreSmelting(consumer, List.of(ModItems.DIRTY_MOON_FRAGMENT.get()), RecipeCategory.MISC,
                ModItems.MOON_FRAGMENT.get(), 0.7f, 200, "moon_fragment");

        nineBlockStorageRecipes(consumer, RecipeCategory.BUILDING_BLOCKS, ModItems.MOON_FRAGMENT.get(), RecipeCategory.MISC,
                ModBlocks.MOON_FRAGMENT_BLOCK.get());
